...
//            $.cookie("datepicker",dateStr,{ expires : 1 })
		}
		this._updateAlternate(inst);
		...
		for (row = 0; row < numMonths[0]; row++) {
			...
			for (col = 0; col < numMonths[1]; col++) {
				...
				for (dow = 0; dow < 7; dow++) { // days of the week
                    ...
                    if((dow + firstDay + 6) % 7 == 6){
                        thead += "<th" + " class='ui-datepicker-week-end sunday'" + ">" +
                            "<span title='" + dayNames[day] + "'>" + dayNamesMin[day] + "</span></th>";
                    }else if((dow + firstDay + 6) % 7 == 5){
    					thead += "<th" + " class='ui-datepicker-week-end saturday'" + ">" +
						"<span title='" + dayNames[day] + "'>" + dayNamesMin[day] + "</span></th>";
                    }else{
                        thead += "<th" + " class=''" + ">" +
                            "<span title='" + dayNames[day] + "'>" + dayNamesMin[day] + "</span></th>";
				...
				for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					...
					for (dow = 0; dow < 7; dow++) { // create date picker days
                        ...
                        var weekendstr = "";
                        if((dow + firstDay + 6) % 7 == 6){
                            weekendstr = " ui-datepicker-week-end sunday";
                        }else if((dow + firstDay + 6) % 7 == 5){
                            weekendstr = " ui-datepicker-week-end saturday";
                        }else{
                            weekendstr = "";
                        }
						tbody += "<td class='" +
							weekendstr + // highlight weekends
